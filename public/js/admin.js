...
function call(id) {
    ...
    connectionInSupport.push(connection); // wind
...
socket.on("admin_receive_message", (data) => {
    // const connection = connectionsUsers.find((connection) => (connection.socket_id === data.socket_id)) // wind
